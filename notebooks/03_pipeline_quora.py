...
from services.indexing_service.indexer import (
    ...
    compute_idf, save_index, INDEX_DIR
)
...
PROC   = Path("data/processed/quora")
IDX    = Path("data/indexes/quora")
...
print("\n🧠 Step 3: Building BERT embeddings (522K docs)...")
print("   ⏳ ممكن ياخذ 20-30 دقيقة...")
emb_module.INDEX_DIR = IDX
build_doc_embeddings(docs_df, batch_size=512)

print("\n✅ Pipeline complete!")
print(f"📁 Indexes saved to {IDX}")
